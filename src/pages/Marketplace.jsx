  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-4">
          <div className="flex flex-col sm:flex-row sm:items-center gap-3">
            <div className="flex-1">
              ...
              <p className="text-xs text-slate-400">Services organized by <strong className="text-white">when they happen</strong> in your transaction · Token credits applied at closing</p>
            </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
        ...
        {/* ── Timeline explainer ── */}
        <div className="mb-6 rounded-2xl border border-slate-700 bg-slate-900 px-5 py-4 flex items-start gap-4">
          <div className="w-9 h-9 rounded-xl bg-slate-800 border border-slate-700 flex items-center justify-center flex-shrink-0 text-lg">📅</div>
          <div>
            <p className="text-sm font-black text-white mb-1">Services Are Unlocked as Your Transaction Progresses</p>
        ...
        {searchResults !== null ? (
          <div>
            ...
            {searchResults.length === 0 ? (
              <div className="text-center py-12">
                ...
                <button onClick={() => setSearch("")} className="mt-3 text-xs text-emerald-400 hover:text-emerald-300 transition underline">Clear search</button>
              </div>
            ) : (
          ...
          <div className="space-y-3">
            ...
            {/* ── Final trust bar ── */}
            <div className="mt-8 rounded-2xl border border-slate-800 bg-slate-900 px-6 py-5">
