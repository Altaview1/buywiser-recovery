              ...
              <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
                <div className="bg-white rounded-xl shadow-2xl w-full max-w-md">
                  <div className="flex items-center justify-between px-6 py-4 border-b border-red-200">
                    <h2 className="text-lg font-bold text-red-700">Delete Leads</h2>
                  ...
                  <div className="p-6 space-y-4">
                    <p className="text-sm text-slate-700 font-medium">Choose what to delete:</p>
                    ...
                    <div className="space-y-3 pt-2">
                      ...
                      <button 
                        ...
                        className="w-full px-4 py-3 bg-red-600 text-white rounded-lg text-sm font-semibold hover:bg-red-700 disabled:bg-slate-300 transition flex items-center justify-center gap-2"
                        disabled={deleting}
                      >
                        {deleting ? (
                          <>
                      ...
                      <button 
                        onClick={async () => {
                          ...
                          try {
                            ...
                            setDeleteResult({ success: true, message: `✓ Deleted ${res.data.deleted_count} leads from last batch` });
                            await loadLeads();
                          } catch (err) {
                            setDeleteResult({ success: false, message: 'Error: ' + err.message });
                          } finally {
                        ...
                        className="w-full px-4 py-3 border border-red-200 text-red-700 bg-red-50 rounded-lg text-sm font-semibold hover:bg-red-100 disabled:bg-slate-200 transition flex items-center justify-center gap-2"
                        disabled={deleting}
                      >
                        {deleting ? (
                          <>
                          ...
                          <>
                            <Trash2 className="h-4 w-4" /> Delete Last Import Batch Only
                          </>
                        )}
                      </button>
                    </div>

                    <button onClick={() => { setShowDeleteImport(false); setDeleteResult(null); }} className="w-full px-4 py-2 border border-slate-200 text-slate-700 rounded-lg text-sm font-semibold hover:bg-slate-50 transition">
                      Cancel
                    </button>
                  </div>
                </div>
