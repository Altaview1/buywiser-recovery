...
import { LogOut, RefreshCw, Users, MapPin, DollarSign, TrendingUp, AlertCircle } from "lucide-react";
              ...
              <table className="w-full text-sm">
                <thead className="bg-slate-50 border-b border-slate-200">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-left font-bold text-slate-600">Rep</th>
                ...
                <tbody className="divide-y divide-slate-100">
                  {leads.slice(0, 20).map(l => (
                    <tr key={l.id} className="hover:bg-slate-50">
                      ...
                      <td className="px-4 py-3 text-xs text-slate-600">{l.property_address}</td>
                      <td className="px-4 py-3">
                        <select
                          value={l.status}
                      ...
                      <td className="px-4 py-3 font-mono text-xs">{l.rep_code}</td>
